const harvestLogMessage = {
  ...
  HARVEST_LOG_UDATE_PASSED_DATE: "Yikes! You cannot update this harvest log after a day has passed. Please submit a correction log",
  ...
  HARVEST_LOG_DELETE_PASSED_DATE: "Yikes! You cannot delete this harvest log after a day has passed. Please submit a correction log",
  ...
  COLLECTED_AMOUNT_GREATER_THAN_ZERO: "Collected amount needs to be greater than zero",  
